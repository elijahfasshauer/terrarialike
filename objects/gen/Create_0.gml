...
world_top = ds_grid_create(width+1, 1); //Each block will have a value, starting with 1. 0 will be air.
...
//Set the top of terrain
	add_height=choose(choose(-2,-1,-1,0,1,1,2),add_prev,add_prev,add_prev)
