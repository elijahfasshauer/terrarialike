...
draw_text(0,400,"Scroll to zoom, Shift to crouch, W to fly, "+string(mine_phase)+" "+string(max_phase)+" "+string(mouse_block))
draw_text(0,425,"R to generate new world, A, D, shift, and space to move")